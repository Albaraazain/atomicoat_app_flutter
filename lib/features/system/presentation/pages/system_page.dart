    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          RealTimeChart(
            data: state.temperatureHistory.map((e) => FlSpot(e.timestamp.toDouble(), e.value)).toList(),
            title: 'Temperature History',
            lineColor: Colors.red,
          ),
          RealTimeChart(
            data: state.pressureHistory.map((e) => FlSpot(e.timestamp.toDouble(), e.value)).toList(),
            title: 'Pressure History',
            lineColor: Colors.green,
          ),
          RealTimeChart(
            data: state.flowRateHistory.map((e) => FlSpot(e.timestamp.toDouble(), e.value)).toList(),
